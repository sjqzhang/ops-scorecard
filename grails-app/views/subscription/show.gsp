                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="service" action="show" id="${subscriptionInstance?.service?.id}">${subscriptionInstance?.service?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${subscriptionInstance?.user?.id}">${subscriptionInstance?.user?.encodeAsHTML()}</g:link></td>

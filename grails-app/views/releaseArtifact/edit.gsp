...
<html>
    <head>
        ...
        <title>Inventory: Edit ReleaseArtifact</title>
    </head>
    <body>
                ...
                <div class="dialog">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: releaseArtifact, field: 'type', 'errors')}">
                            <g:select optionKey="id" from="${ResourceType.findAllByMetatype('artifact')}" name="type.id" value="${releaseArtifact?.type?.id}"></g:select>
                        </td>
                    </tr>

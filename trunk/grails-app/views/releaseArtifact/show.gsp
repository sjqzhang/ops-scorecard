...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="list" action="list">ReleaseArtifact List</g:link></span>
            <span class="menuButton"><g:link class="create" action="create">New ReleaseArtifact</g:link></span>
        </div>
        <div class="body">
            <h1>Show ReleaseArtifact</h1>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:releaseArtifact, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:releaseArtifact, field:'category')}</td>
